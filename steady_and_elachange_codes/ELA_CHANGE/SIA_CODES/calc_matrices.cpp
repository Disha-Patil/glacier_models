#include "globals.h"
double ela_change=0; 
void fill_d(MatrixXd& d, MatrixXd& h, MatrixXd& bed, MatrixXi& m,VectorXd& neigh1,VectorXd& neigh2,VectorXd& neigh3,VectorXd& neigh4, std::vector<std::array<int,2>> domain){
