...
#include <eigen3/Eigen/Sparse>             // include the eigen sparse header files
...
#include <chrono>
#include <eigen3/Eigen/Core>               // eigen core headers with datastructures 

#include <eigen3/Eigen/IterativeLinearSolvers>                    // eigen headers for iterative methods like CG and BiCG   
#include <eigen3/unsupported/Eigen/IterativeSolvers>              // methods like housholders algo https://eigen.tuxfamily.org/dox/unsupported/group__IterativeSolvers__Module.html
#include <Python.h>
#include <string.h>
